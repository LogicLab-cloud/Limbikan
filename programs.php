  ...
  <div class="container">
    <div class="row justify-content-center mb-5 pb-3">
      <div class="col-md-7 heading-section ftco-animate text-center">
        <h2 class="mb-4" id="events">Programs</h2>
      </div>
    </div>
    <div class='row'>
      ...
      foreach ($results as $row) {
        ...
        $logoUrl = "./backend/setters/img/programs/" . $image;
        //$logoUrl = "./backend/setters/img/programs/environment7641016_98777624_1695015833.png";
